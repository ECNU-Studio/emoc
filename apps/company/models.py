...
class Companys(models.Model):
    ...
    legalperson = models.CharField(max_length=45, verbose_name=_(u"法人"))
    address = models.CharField(max_length=45, verbose_name=_(u"企业地址"))
    cover = models.CharField(max_length=45, verbose_name=_(u"企业封面"))
    memo = models.CharField(max_length=45, verbose_name=_(u"备注"))
    state = models.BooleanField(max_length=45, verbose_name=_(u"是否有效"))
