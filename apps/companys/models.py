...
class Users(models.Model):
    ...
    department = models.CharField(max_length=45, verbose_name=_(u"部门"))
    position = models.CharField(max_length=45, verbose_name=_(u"职位"))
    # openid = models.CharField(max_length=45, verbose_name=_(u"微信openid"))
    # qq = models.CharField(max_length=45, verbose_name=_(u"QQ"))
    tel = models.CharField(max_length=45, verbose_name=_(u"电话"))
    ...
    total_class = models.IntegerField(default=0,  verbose_name=_(u"学习课程"))
